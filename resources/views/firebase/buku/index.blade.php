        ...
        @endif
            ...
            <div class="card">
                <div class="card-header">
                    <h4>
                        Daftar buku
                        <a href="{{url('tambah-buku')}}" class="btn btn-sm btn-primary float-end">Tambah Buku</a>
                    </h4>
                </div>
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ url('edit-buku/'.$key) }}" class="btn btn-sm btn-success">Edit</a></td>
                                <td><a href="{{ url('hapus-buku/'.$key) }}"class="btn btn-sm btn-danger">Hapus</a></td>
                            </tr>
                            @empty
                            <tr>
